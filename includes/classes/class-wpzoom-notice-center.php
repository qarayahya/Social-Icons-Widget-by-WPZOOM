		...
		private function render_single_notice( $notice ) {
			...
			<div class="notice wpzoom-notice-single" data-notice-id="<?php echo esc_attr( $notice['id'] ); ?>">
				...
				<button type="button" class="notice-dismiss wpzoom-nc-dismiss-single" data-notice-id="<?php echo esc_attr( $notice['id'] ); ?>">
					<span class="screen-reader-text"><?php esc_html_e( 'Dismiss this notice.', 'social-icons-widget-by-wpzoom' ); ?></span>
				</button>
			</div>
			<?php
		}
			...
			<div id="wpzoom-notice-center" class="notice wpzoom-notice-center" data-total="<?php echo (int) $total; ?>">
				...
				<div class="wpzoom-nc-header">
					<div class="wpzoom-nc-header__left">
						<span class="wpzoom-nc-header__title"><?php esc_html_e( 'WPZOOM Notice Center', 'social-icons-widget-by-wpzoom' ); ?></span>
						<span class="wpzoom-nc-header__subtitle"><?php esc_html_e( 'Stay updated with the latest from WPZOOM products and services!', 'social-icons-widget-by-wpzoom' ); ?></span>
					</div>
					<div class="wpzoom-nc-header__right">
						<button type="button" class="wpzoom-nc-dismiss-slide" title="<?php esc_attr_e( 'Dismiss this notice', 'social-icons-widget-by-wpzoom' ); ?>">
