...
class WPZOOM_Click_To_Chat {
	...
	public function render_admin_page() {
					...
					<div class="wpzoom-ctc-col">
						...
						<div class="wpzoom-ctc-card">
							...
							<div class="wpzoom-ctc-field">
								...
								<!-- Large preview -->
								<?php
								// Build preview platforms in saved order; fallback to all three if none enabled.
								...
								foreach ( $preview_order as $key ) {
									if ( isset( $all_platforms_map[ $key ] ) && ! empty( $s[ $key . '_enabled' ] ) ) {
								...
								<div class="wpzoom-ctc-style-preview" id="ctc-style-preview"
									...
									<div class="wpzoom-ctc-sp-corner">
										<div class="wpzoom-ctc-sp-buttons">
											...
											<span class="wpzoom-ctc-sp-btn wpzoom-ctc-sp-btn--<?php echo esc_attr( $p['key'] ); ?>" style="background:<?php echo esc_attr( $p['color'] ); ?>">
												<?php echo $p['icon']; // phpcs:ignore ?>
											</span>
											<?php endforeach; ?>
										</div>
		...
		jQuery(function($) {
			...
			/* Platform toggles: show/hide their fields */
